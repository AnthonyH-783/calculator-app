...
## Key Features
- Caclulator input is dynamically re-sized based on length
- Supports any reasonable number of operands (as long as font size remains readable)
- All Decimals are rounded to two decimal places to prevent screen overflow
